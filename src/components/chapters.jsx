    ...
    <TabPage>
      ...
      <BackgroundModal className={openModal === "id1" ? "borderBlue" : ""}>
        <Modal className={openModal === "id1" ? "visible" : "hidden"}>
          ...
          émergent rapidement. Le cercle vertueux se met en place. La culture de
          l’entreprise change.
          <br />
          <br />
          <SchemaContainer>
          ...
          clients. Nous sommes fiers d’avoir redécouvert que les choses les plus
          simples sont les plus efficaces. Nous sommes fiers de remettre
      ...
      <BackgroundModal className={openModal === "id2" ? "borderBlack" : ""}>
        <Modal className={openModal === "id2" ? "visible" : "hidden"}>
          ...
          <br />
          <br />
          Si chaque entreprise est unique, son voyage sera aussi unique. Mais il
          y a des points de passage obligés. Des leviers importants. Ils sont au
          nombre de 4.
          <br />
          <br />
          <SchemaContainer>
          ...
          <br />
          <br />
          Sans doute avez-vous une bonne vision, une bonne stratégie pour votre
          entreprise ?
          <br />
          <br />
          Sans doute avez-vous à maintes reprises essayé de vous appuyer sur vos
          équipes ? Sans succès…
          <br />
          <br />
          Sans doute estimez-vous que votre manière de manager est la seule qui
          soit efficace pour votre entreprise.
          <br />
          <br />
      ...
      <BackgroundModal className={openModal === "id3" ? "borderRed" : ""}>
        <Modal className={openModal === "id3" ? "visible" : "hidden"}>
          <Title>Chapitre 3 : Témoignages</Title>
