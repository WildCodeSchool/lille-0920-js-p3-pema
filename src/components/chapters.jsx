        ...
        >
          <Modal className={openModal.modal1 === "id1" ? "visible" : "hidden"}>
            ...
            <p>
              ...
              insoupçonnées de votre entreprise. La principale d’entre elle est
              votre équipe.
              <br />
              <br />
              ...
              manque de sens… Lorsque l’esprit d’équipe est retrouvé, les
              motivations reviennent, les idées naissent, les initiatives
              fleurissent, la confiance et la solidarité se développent.
              <br />
              <br />
              ...
              émergent rapidement. Le cercle vertueux se met en place. La
              culture de l’entreprise change.
              <br />
              <br />
              <SchemaContainer>
